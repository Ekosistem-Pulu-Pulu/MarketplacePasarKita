...
export function render() {
  ...
  return `
    ...
    <section class="container profile-layout">
      <aside class="profile-menu-card"><a class="active"><span data-lucide="user"></span>Informasi Profil</a><a href="#/orders"><span data-lucide="package"></span>Pesanan Saya</a><a><span data-lucide="heart"></span>Wishlist</a><a><span data-lucide="ticket-percent"></span>Voucher Saya</a><a href="#/seller"><span data-lucide="store"></span>Dashboard Seller</a></aside>
      <main>
